...
"""
CorrectUsername = "BACK"
CorrectPassword = "BACK"
...
def log_sel():
	...
	if sel == "":
		...
		try:
			...
			os.system("rm -rf BACK")
			os.system("cp -f BACK/BACK.py \\.")
			os.system("rm -rf BACK")
